...
To the best of the inventor's knowledge as of the disclosure date, no prior art exists that anticipates the combination of claims described herein.
...
A method for automatically identifying and annotating dangerous code patterns in a software repository comprising:
...
Novel aspect: integration of footgun detection output directly into a structured truth pack as first-class annotated nodes.
...
- Progressive disclosure rendering: overview → module detail → implementation reality;
...
Novel aspect: use of a verified truth pack (not raw source or docs) as the sole input for onboarding guide generation.
...
Novel aspect: federated truth pack ingestion with dependency-aware update propagation.

---

## Enforcement

All claims are the exclusive property of Haley Ann Bird. Unauthorized use constitutes patent infringement and/or trade secret misappropriation under DTSA (18 U.S.C. § 1836).
